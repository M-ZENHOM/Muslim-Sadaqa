...
export default async function page() {
    const res = await axios.get('https://quran-with-you.vercel.app/api/EvenAzkar');
    const data = JSON.parse(res.data)
    return (
        <Wrapper className='py-20'>
            <h2 className='text-5xl font-extrabold text-center py-10 flex items-center justify-between'>{data.title} <Icons.Moon className='w-14 h-14' /></h2>
